...
typedef struct {
  ...
  boolean_T Compare_k;                 /* '<S4>/Compare' */
} B_untitled2_T;
...
/* External outputs (root outports fed by signals with default storage) */
extern ExtY_untitled2_T untitled2_Y;
 ...
 *
 * '<Root>' : 'untitled2'
 * '<S1>'   : 'untitled2/Compare To Constant'
 * '<S2>'   : 'untitled2/Compare To Constant1'
 * '<S3>'   : 'untitled2/Compare To Constant2'
 * '<S4>'   : 'untitled2/Compare To Constant4'
 */
#endif                                 /* untitled2_h_ */
